...
void setup() {
  ...
  Serial.println("Iniciando A2DP...");

  a2dp_source.set_data_callback_in_frames(get_data_frames);
  a2dp_source.set_volume(30);

  Serial.println("Intentando conectar a Hazy Audio");

  a2dp_source.start("Hazy Audio");

  Serial.println("Comando de conexion enviado");
}
